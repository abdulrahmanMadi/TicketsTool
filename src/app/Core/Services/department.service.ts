...
import { API_Response, Department } from '../Models/APIModel';
...
export class DepartmentService {
 ...
 CreateDepartment(obj:Department):Observable<API_Response>{
    return this.http.post<API_Response>(environment.API_Url + Constants.API_Endpoint.Create_Department,obj);
  }

  UpdateDepartment(obj:Department):Observable<API_Response>{
