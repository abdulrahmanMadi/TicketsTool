...
export class DepartmentService {
  ...
  GetEmployeesByDepartment(departmentId: number): Observable<API_Response> {
    return this.http.get<API_Response>(`${environment.API_Url}${Constants.API_Endpoint.GetEmployeesByDepartment}/${departmentId}`);
  }
}
